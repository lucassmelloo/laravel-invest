...
<div class="p-4 sm:p-8 bg-white shadow sm:rounded-lg">
    <section class="space-y-6">
        ...
        <div>
            ...
            <x-text-input wire:model="search" id="search" name="search" type="text" class="mt-1 block w-full" required autofocus autocomplete="name" />
        </div>
                    ...
                    <tr class="bg-white border-b hover:bg-gray-200">
                        ...
                        <td class="px-6 py-4">
                            <div class="flex ">
                                ...
                                <livewire:indexers.modals.edit/>

                                <button
                                    title="Audit"
                                    x-data="{index: {{$index}}}"
                                    x-on:click.prevent="$dispatch('open-modal', 'audit-indexer-{{$index->id}}')">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-7 h-7 hover:bg-sky-300 hover:fill-sky-300 rounded-lg p-0.5 transition duration-300">
                                ...
                                <button
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-7 h-7 hover:bg-red-300 hover:fill-red-300 rounded-lg p-0.5 transition duration-300">
