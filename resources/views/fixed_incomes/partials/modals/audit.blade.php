...
<x-modal name="audit-fixed-income-{{$fixed_income->id}}" title="Audit: {{$fixed_income->title}}" :scrollable="true" >
    <div class="p-6">
        <h2 class="text-lg font-medium text-gray-900">
            <strong>{{ __('Audit: ') }}</strong>{{__($fixed_income->title)}}
        </h2>
        ...
        <div>
            @foreach ($fixed_income->audits->reverse() as $audit)
